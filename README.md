...
A modern web application for tracking teams, players, and matches in the UPA Summer Championship, an NBA 2K Pro Am tournament. Built with Next.js 14, TypeScript, Material-UI, and Supabase.
